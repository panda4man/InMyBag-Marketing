...
(function () {
	'use strict';
	angular.module('app', ['ui.router', 'app.templates', 'app.config', 'app.run', 'app.constants', 'app.controllers', 'app.factories', 'app.services']);
})();
(function() {
    'use strict';
    angular
...
angular.module("app.templates").run(["$templateCache", function($templateCache) {$templateCache.put("app/home.html","<div class=row><div class=col-sm-12><h1>Welcome Home, {{siteName}}</h1></div></div>");}]);